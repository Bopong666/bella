...
class ComponentKriteria extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.component-kriteria', ['lists' =>  Kriteria::paginate(10)])->extends('layouts.app')->section('content');
    }
    ...
    public function store()
    {
        ...
        if ($this->idTerpilih) {
            ...
            foreach ($dataAlternatif as $key => $item) {
                $datamasuk['alternatif_id'] = $item->id;
                $datamasuk['sub_kriteria_id'] = $dataSubKriteriaPertama->id;
                DB::table('alternatif_sub_kriteria')->insert($datamasuk);
            }
        }
